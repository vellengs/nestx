...
public interface PageApi {
    ...
    default ResponseEntity<PageRes> pageCreate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody CreatePageReq createPageReq) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"template\" : \"template\",  \"disable\" : true,  \"meta\" : \"meta\",  \"publish\" : \"publish\",  \"name\" : \"name\",  \"description\" : \"description\",  \"id\" : \"id\",  \"sort\" : 0.80082819046101150206595775671303272247314453125,  \"title\" : \"title\",  \"content\" : \"content\"}");
                    break;
                }
            }
        });
    ...
    @ApiOperation(value = "", nickname = "pageSearch", notes = "", response = KeyValueDto.class, responseContainer = "List", tags={ "cms", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Ok", response = KeyValueDto.class, responseContainer = "List") })
    @RequestMapping(value = "/page/search",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<List<KeyValueDto>> pageSearch(@ApiParam(value = "") @Valid @RequestParam(value = "keyword", required = false) String keyword,@ApiParam(value = "") @Valid @RequestParam(value = "value", required = false) String value) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<PageRes> pageUpdate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody EditPageReq editPageReq) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"template\" : \"template\",  \"disable\" : true,  \"meta\" : \"meta\",  \"publish\" : \"publish\",  \"name\" : \"name\",  \"description\" : \"description\",  \"id\" : \"id\",  \"sort\" : 0.80082819046101150206595775671303272247314453125,  \"title\" : \"title\",  \"content\" : \"content\"}");
