...
public interface MenuApi {
    ...
    default ResponseEntity<Void> menusCreate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody CreateMenuReq createMenuReq) {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"parent\" : \"parent\",  \"blank\" : true,  \"externalLink\" : \"externalLink\",  \"link\" : \"link\",  \"icon\" : \"icon\",  \"badgeDot\" : \"badgeDot\",  \"badgeStatus\" : \"badgeStatus\",  \"acl\" : \"acl\",  \"isMenu\" : true,  \"badge\" : \"badge\",  \"expanded\" : true,  \"enable\" : true,  \"paths\" : [ \"{}\", \"{}\" ],  \"permissions\" : [ \"{}\", \"{}\" ],  \"name\" : \"name\",  \"id\" : \"id\",  \"slug\" : \"slug\",  \"group\" : true,  \"order\" : 0.80082819046101150206595775671303272247314453125}");
                    break;
                }
            }
        });
    ...
    @ApiOperation(value = "", nickname = "menusGetPermissionTags", notes = "", response = InlineResponse200.class, responseContainer = "List", tags={ "core", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/menu/permissions",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<List<InlineResponse200>> menusGetPermissionTags() {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<ResultListMenu> menusQuery(@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "isMenu", required = true) Boolean isMenu,@ApiParam(value = "") @Valid @RequestParam(value = "keyword", required = false) String keyword,@ApiParam(value = "", defaultValue = "1.0d") @Valid @RequestParam(value = "page", required = false, defaultValue="1.0d") Double page,@ApiParam(value = "", defaultValue = "10.0d") @Valid @RequestParam(value = "size", required = false, defaultValue="10.0d") Double size,@ApiParam(value = "") @Valid @RequestParam(value = "sort", required = false) String sort) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"query\" : {    \"size\" : 6.02745618307040320615897144307382404804229736328125,    \"page\" : 1.46581298050294517310021547018550336360931396484375  },  \"count\" : 0.80082819046101150206595775671303272247314453125,  \"list\" : [ {    \"parent\" : \"{}\",    \"blank\" : true,    \"externalLink\" : \"externalLink\",    \"link\" : \"link\",    \"icon\" : \"icon\",    \"badgeDot\" : \"badgeDot\",    \"badgeStatus\" : \"badgeStatus\",    \"acl\" : \"acl\",    \"isMenu\" : true,    \"badge\" : \"badge\",    \"expanded\" : true,    \"enable\" : true,    \"paths\" : [ \"{}\", \"{}\" ],    \"permissions\" : [ \"{}\", \"{}\" ],    \"name\" : \"name\",    \"id\" : \"id\",    \"slug\" : \"slug\",    \"group\" : true,    \"order\" : 0.80082819046101150206595775671303272247314453125  }, {    \"parent\" : \"{}\",    \"blank\" : true,    \"externalLink\" : \"externalLink\",    \"link\" : \"link\",    \"icon\" : \"icon\",    \"badgeDot\" : \"badgeDot\",    \"badgeStatus\" : \"badgeStatus\",    \"acl\" : \"acl\",    \"isMenu\" : true,    \"badge\" : \"badge\",    \"expanded\" : true,    \"enable\" : true,    \"paths\" : [ \"{}\", \"{}\" ],    \"permissions\" : [ \"{}\", \"{}\" ],    \"name\" : \"name\",    \"id\" : \"id\",    \"slug\" : \"slug\",    \"group\" : true,    \"order\" : 0.80082819046101150206595775671303272247314453125  } ]}");
                    break;
                }
            }
        });
    ...
    default ResponseEntity<Menu> menusUpdate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody EditMenuReq editMenuReq) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"parent\" : \"{}\",  \"blank\" : true,  \"externalLink\" : \"externalLink\",  \"link\" : \"link\",  \"icon\" : \"icon\",  \"badgeDot\" : \"badgeDot\",  \"badgeStatus\" : \"badgeStatus\",  \"acl\" : \"acl\",  \"isMenu\" : true,  \"badge\" : \"badge\",  \"expanded\" : true,  \"enable\" : true,  \"paths\" : [ \"{}\", \"{}\" ],  \"permissions\" : [ \"{}\", \"{}\" ],  \"name\" : \"name\",  \"id\" : \"id\",  \"slug\" : \"slug\",  \"group\" : true,  \"order\" : 0.80082819046101150206595775671303272247314453125}");
                    break;
                }
            }
        });
