...
public interface GroupApi {
    ...
    default ResponseEntity<Void> groupsCreate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody CreateGroupReq createGroupReq) {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"parent\" : \"parent\",  \"paths\" : [ \"{}\", \"{}\" ],  \"director\" : \"director\",  \"name\" : \"name\",  \"icon\" : \"icon\",  \"description\" : \"description\",  \"outid\" : 0.80082819046101150206595775671303272247314453125,  \"id\" : \"id\",  \"isRegion\" : true,  \"order\" : 6.02745618307040320615897144307382404804229736328125}");
                    break;
                }
            }
        });
    ...
    default ResponseEntity<ResultListGroup> groupsQuery(@ApiParam(value = "") @Valid @RequestParam(value = "keyword", required = false) String keyword,@ApiParam(value = "", defaultValue = "1.0d") @Valid @RequestParam(value = "page", required = false, defaultValue="1.0d") Double page,@ApiParam(value = "", defaultValue = "10.0d") @Valid @RequestParam(value = "size", required = false, defaultValue="10.0d") Double size,@ApiParam(value = "") @Valid @RequestParam(value = "sort", required = false) String sort) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"query\" : {    \"size\" : 6.02745618307040320615897144307382404804229736328125,    \"page\" : 1.46581298050294517310021547018550336360931396484375  },  \"count\" : 0.80082819046101150206595775671303272247314453125,  \"list\" : [ {    \"parent\" : \"parent\",    \"paths\" : [ \"{}\", \"{}\" ],    \"director\" : \"director\",    \"name\" : \"name\",    \"icon\" : \"icon\",    \"description\" : \"description\",    \"outid\" : 0.80082819046101150206595775671303272247314453125,    \"id\" : \"id\",    \"isRegion\" : true,    \"order\" : 6.02745618307040320615897144307382404804229736328125  }, {    \"parent\" : \"parent\",    \"paths\" : [ \"{}\", \"{}\" ],    \"director\" : \"director\",    \"name\" : \"name\",    \"icon\" : \"icon\",    \"description\" : \"description\",    \"outid\" : 0.80082819046101150206595775671303272247314453125,    \"id\" : \"id\",    \"isRegion\" : true,    \"order\" : 6.02745618307040320615897144307382404804229736328125  } ]}");
                    break;
                }
            }
        });
    ...
    default ResponseEntity<Group> groupsUpdate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody EditGroupReq editGroupReq) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"parent\" : \"parent\",  \"paths\" : [ \"{}\", \"{}\" ],  \"director\" : \"director\",  \"name\" : \"name\",  \"icon\" : \"icon\",  \"description\" : \"description\",  \"outid\" : 0.80082819046101150206595775671303272247314453125,  \"id\" : \"id\",  \"isRegion\" : true,  \"order\" : 6.02745618307040320615897144307382404804229736328125}");
