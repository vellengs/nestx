...
export const AuthApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        authLogin(loginReq: LoginReq, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<string> {
         ...
         * @throws {RequiredError}
         */
        authRegister(registerReq: RegisterReq, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<string> {
...
export const CoreApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        menusQuery(keyword?: string, index?: number, size?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ResultListMenu> {
            const localVarAxiosArgs = CoreApiAxiosParamCreator(configuration).menusQuery(keyword, index, size, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = Object.assign(localVarAxiosArgs.options, {url: basePath + localVarAxiosArgs.url})
                return axios.request(axiosRequestArgs);                
            };
...
export class CoreApi extends BaseAPI {
    ...
    public menusQuery(keyword?: string, index?: number, size?: number, options?: any) {
        return CoreApiFp(this.configuration).menusQuery(keyword, index, size, options)(this.axios, this.basePath);
    }
