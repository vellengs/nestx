...
import { TagSelect, Ellipsis } from 'ant-design-pro';
...
@connect(({ list, loading }: any) => ({
  list,
  loading: loading.models.list,
}))
class CoverCardList extends PureComponent<any> {
  componentDidMount() {
...
export default Form.create(params)(CoverCardList);
