...
let AppearancesService = class AppearancesService extends mongoose_service_1.MongooseService {
    constructor(model) {
        super(model);
        this.model = model;
        this.defaultQueryFields = ['name', 'options', 'data'];
    }
};
AppearancesService = __decorate([
    common_1.Injectable(),
    __param(0, mongoose_2.InjectModel('Appearance')),
