...
public interface SettingApi {
    ...
    default ResponseEntity<Void> settingsCreate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody CreateSettingReq entry) {
    ...
    default ResponseEntity<ResultListSetting> settingsQuery(@ApiParam(value = "") @Valid @RequestParam(value = "keyword", required = false) String keyword,@ApiParam(value = "", defaultValue = "1.0d") @Valid @RequestParam(value = "page", required = false, defaultValue="1.0d") Double page,@ApiParam(value = "", defaultValue = "10.0d") @Valid @RequestParam(value = "size", required = false, defaultValue="10.0d") Double size,@ApiParam(value = "") @Valid @RequestParam(value = "sort", required = false) String sort) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"query\" : {    \"size\" : 6.027456183070403,    \"page\" : 1.4658129805029452  },  \"count\" : 0.8008281904610115,  \"list\" : [ {    \"name\" : \"name\",    \"description\" : \"description\",    \"id\" : \"id\",    \"value\" : \"{}\",    \"key\" : \"key\"  }, {    \"name\" : \"name\",    \"description\" : \"description\",    \"id\" : \"id\",    \"value\" : \"{}\",    \"key\" : \"key\"  } ]}");
                    break;
                }
            }
        });
    ...
    default ResponseEntity<Setting> settingsUpdate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody EditSettingReq entry) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"name\" : \"name\",  \"description\" : \"description\",  \"id\" : \"id\",  \"value\" : \"{}\",  \"key\" : \"key\"}");
    ...
    @RequestMapping(value = "/setting/name/{name}",
        ...
        consumes = { "application/json" },
        method = RequestMethod.PUT)
    default ResponseEntity<SettingsGroup> settingsUpdateSettingsByName(@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "name", required = true) String name,@ApiParam(value = "" ,required=true )  @Valid @RequestBody SettingsGroup entry) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"options\" : \"{}\"}");
