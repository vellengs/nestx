...
public interface UserApi {
    ...
    default ResponseEntity<Result> usersAddUsersToRole(@ApiParam(value = "" ,required=true )  @Valid @RequestBody UsersOfRole users) {
    ...
    default ResponseEntity<Result> usersChangePassword(@ApiParam(value = "" ,required=true )  @Valid @RequestBody ChangePasswordReq entry) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"ok\" : true,  \"message\" : \"message\"}");
    ...
    @RequestMapping(value = "/user/",
        ...
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<UserRes> usersCreate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody CreateUserReq user) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"siteUrl\" : \"siteUrl\",  \"address\" : \"address\",  \"roles\" : [ \"roles\", \"roles\" ],  \"mobile\" : \"mobile\",  \"avatar\" : \"avatar\",  \"isAdmin\" : true,  \"expired\" : 0.8008281904610115,  \"name\" : \"name\",  \"company\" : \"company\",  \"id\" : \"id\",  \"isApproved\" : true,  \"email\" : \"email\",  \"username\" : \"username\"}");
                    break;
                }
            }
        });
    ...
    default ResponseEntity<User> usersProfile() {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"roles\" : [ \"roles\", \"roles\" ],  \"profile\" : \"{}\",  \"mobile\" : \"mobile\",  \"groups\" : [ \"groups\", \"groups\" ],  \"avatar\" : \"avatar\",  \"isAdmin\" : true,  \"secret\" : \"secret\",  \"type\" : \"type\",  \"isDisable\" : true,  \"password\" : \"password\",  \"expired\" : 0.8008281904610115,  \"name\" : \"name\",  \"id\" : \"id\",  \"keyword\" : \"keyword\",  \"isApproved\" : true,  \"email\" : \"email\",  \"username\" : \"username\"}");
                    break;
                }
            }
        });
    ...
    default ResponseEntity<ResultListUser> usersQuery(@ApiParam(value = "") @Valid @RequestParam(value = "keyword", required = false) String keyword,@ApiParam(value = "") @Valid @RequestParam(value = "group", required = false) String group,@ApiParam(value = "") @Valid @RequestParam(value = "role", required = false) String role,@ApiParam(value = "", defaultValue = "1.0d") @Valid @RequestParam(value = "page", required = false, defaultValue="1.0d") Double page,@ApiParam(value = "", defaultValue = "10.0d") @Valid @RequestParam(value = "size", required = false, defaultValue="10.0d") Double size,@ApiParam(value = "") @Valid @RequestParam(value = "sort", required = false) String sort) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"query\" : {    \"size\" : 6.027456183070403,    \"page\" : 1.4658129805029452  },  \"count\" : 0.8008281904610115,  \"list\" : [ {    \"roles\" : [ \"roles\", \"roles\" ],    \"profile\" : \"{}\",    \"mobile\" : \"mobile\",    \"groups\" : [ \"groups\", \"groups\" ],    \"avatar\" : \"avatar\",    \"isAdmin\" : true,    \"secret\" : \"secret\",    \"type\" : \"type\",    \"isDisable\" : true,    \"password\" : \"password\",    \"expired\" : 0.8008281904610115,    \"name\" : \"name\",    \"id\" : \"id\",    \"keyword\" : \"keyword\",    \"isApproved\" : true,    \"email\" : \"email\",    \"username\" : \"username\"  }, {    \"roles\" : [ \"roles\", \"roles\" ],    \"profile\" : \"{}\",    \"mobile\" : \"mobile\",    \"groups\" : [ \"groups\", \"groups\" ],    \"avatar\" : \"avatar\",    \"isAdmin\" : true,    \"secret\" : \"secret\",    \"type\" : \"type\",    \"isDisable\" : true,    \"password\" : \"password\",    \"expired\" : 0.8008281904610115,    \"name\" : \"name\",    \"id\" : \"id\",    \"keyword\" : \"keyword\",    \"isApproved\" : true,    \"email\" : \"email\",    \"username\" : \"username\"  } ]}");
                    break;
                }
            }
        });
    ...
    @RequestMapping(value = "/user/",
        ...
        consumes = { "application/json" },
        method = RequestMethod.PUT)
    default ResponseEntity<UserRes> usersUpdate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody EditUserReq user) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"siteUrl\" : \"siteUrl\",  \"address\" : \"address\",  \"roles\" : [ \"roles\", \"roles\" ],  \"mobile\" : \"mobile\",  \"avatar\" : \"avatar\",  \"isAdmin\" : true,  \"expired\" : 0.8008281904610115,  \"name\" : \"name\",  \"company\" : \"company\",  \"id\" : \"id\",  \"isApproved\" : true,  \"email\" : \"email\",  \"username\" : \"username\"}");
    ...
    @RequestMapping(value = "/user/profile",
        ...
        consumes = { "application/json" },
        method = RequestMethod.PUT)
    default ResponseEntity<UserRes> usersUpdateProfile(@ApiParam(value = "" ,required=true )  @Valid @RequestBody EditProfileReq user) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"siteUrl\" : \"siteUrl\",  \"address\" : \"address\",  \"roles\" : [ \"roles\", \"roles\" ],  \"mobile\" : \"mobile\",  \"avatar\" : \"avatar\",  \"isAdmin\" : true,  \"expired\" : 0.8008281904610115,  \"name\" : \"name\",  \"company\" : \"company\",  \"id\" : \"id\",  \"isApproved\" : true,  \"email\" : \"email\",  \"username\" : \"username\"}");
