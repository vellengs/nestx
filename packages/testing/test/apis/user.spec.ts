...
describe('user module test', () => {
    ...
    it('[put] /user/', async () => {
        ...
        const user = await HttpClient.coreApi.usersFindOne('5b31eba49a674f606f7c5849');
        const reqBody = {
            id: user.data.id,
    ...
    it('[post] /user/role', async () => {
        const reqBody = {
            ...
            userIds: ['5b31eba49a674f606f3c5841', '5b31eba49a674f606f3c5842', '5b31eba49a674f606f3c5843'],
        };
    ...
    it('[get] /user/query', async () => {
        ...
        const page = 0;
        const size = 10;
        const res = await HttpClient.coreApi.usersQuery(null, page, size);
        expect(res.status).toBe(200);
        expect(res.data.list.length).toBeGreaterThan(0);
    });

    it('[get] /user/{id}', async () => {
        const res = await HttpClient.coreApi.usersFindOne('5b31eba49a674f606f3c5841');
        expect(res.status).toBe(200);
